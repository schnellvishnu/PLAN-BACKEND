    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regulation', models.CharField(default=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Draft', 'Draft'), ('Inproduction', 'Inproduction'), ('Running', 'Running'), ('Paused', 'Paused'), ('Shipping', 'Shipping'), ('InShipping', 'InShipping'), ('Closed', 'Closed'), ('Fullyreleased', 'Fullyreleased')], default='Shipping', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.CharField(max_length=100)),
                ...
                ('process_order_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processorderno_to_shippo', to='masterapp.productionorder')),
